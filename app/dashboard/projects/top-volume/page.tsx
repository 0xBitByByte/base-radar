...
/** PR-061 — Task 2 & 7: dedicated collection route for "topVolume" — see `renderProjectsCollectionRoute` for the shared pipeline every route in this family calls. */
export default async function TopVolumePage({ searchParams }: PageProps) {
