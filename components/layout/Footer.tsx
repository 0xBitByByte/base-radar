...
/** GitHub/X's neutral hover matches `Sidebar`'s theme-aware version of the same hover now that Footer supports both themes too; only the brand-color hovers (Discord/Telegram/Linktree) are shared, via `buildSocialNavLinks`. */
...
export function Footer() {
  ...
  return (
    <footer className="border-t border-radar-light-border bg-radar-light-bg dark:border-white/5 dark:bg-radar-bg">
      <div className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-6">
          <div className="group flex flex-col gap-3 sm:col-span-2 lg:col-span-2">
