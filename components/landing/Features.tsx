...
const FEATURE_ITEMS: FeatureItem[] = [
  ...
  },
  {
    icon: Newspaper,
    title: "Daily Brief",
    description: "One AI-written summary of what changed across your watchlist — opportunities, risks, and what to do next.",
    href: "/dashboard/brief",
  },
  {
    icon: Wallet,
    title: "Portfolio Intelligence",
    description: "Health, risk, and momentum scored across every project on your watchlist — one view, always current.",
  ...
  },
  {
    icon: Zap,
    title: "Automation",
    description: "Set rules once, and Base Radar acts on alert conditions automatically — no manual checking required.",
  ...
  },
  {
    ...
    description: "A chronological feed of every AI-surfaced event across your watchlist — see what happened, in order.",
