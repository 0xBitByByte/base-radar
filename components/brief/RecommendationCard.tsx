...
/** One recommendation, exactly as `lib/brief/sections.ts`'s `buildRecommendations` produced it — this component never generates or rewords text, only displays what the Daily Brief already decided. */
